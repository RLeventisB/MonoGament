...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    /// sent to the GPU).
    /// </summary>
    public class DepthlessSpriteBatcher : IDepthlessSpriteBatcher
    {
        /*
        ...
        private DepthlessSpriteBatchItem.VertexPositionColorTexture[] _vertexArray;

        public DepthlessSpriteBatcher(GraphicsDevice device, int capacity = 0)
        {
            _device = device;
            ...
            _batchItemList = new DepthlessSpriteBatchItem[capacity];
            numSprites = 0;
        ...
        {
            if (numSprites >= _batchItemList.Length)
            {
            ...
            var item = _batchItemList[numSprites++];
            return item;
        }
        ...
        private unsafe void EnsureArrayCapacity(int numBatchItems)
        {
            ...
            _vertexArray = new DepthlessSpriteBatchItem.VertexPositionColorTexture[4 * numBatchItems];
        }
        ...
        public unsafe void DrawBatch(Effect effect)
        {
            ...
            while (batchCount > 0)
            {
                ...
                fixed (DepthlessSpriteBatchItem.VertexPositionColorTexture* vertexArrayFixedPtr = _vertexArray)
                {
                    ...
                    {
                        DepthlessSpriteBatchItem item = _batchItemList[batchIndex];
            ...
            if (effect != null)
            {
                ...
                foreach (var pass in passes)
                {
                    ...
                    _device.DrawUserIndexedPrimitives(
                        ...
                        0,
                        vertexCount / 4 * 2,
                        DepthlessSpriteBatchItem.VertexPositionColorTexture.VertexDeclaration);
                }
            }
            else
            {
